...
16. [Incorrect username submission shows an error page; correct username with incorrect password may lead to user enumeration](#bug-16-incorrect-username-submission-shows-an-error-page-correct-username-with-incorrect-password-may-lead-to-user-enumeration)
...
---
## Bug 16: Incorrect username submission shows an error page; correct username with incorrect password may lead to user enumeration
